      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-slate-100 dark:border-slate-900 pb-10">
        <div className="space-y-3">
          ...
          <h1 className="text-4xl font-bold tracking-tight text-slate-900 dark:text-white uppercase">
            System{" "}
            <span className="font-light text-slate-400 text-3xl">
              / Overview
            </span>
          </h1>
        </div>
        <div className="text-right">
          ...
          <p className="text-xs font-mono mt-1 text-slate-600 dark:text-slate-500 uppercase">
            UID: {user?._id}
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        {[
          ...
          },
          {
            ...
            val: new Set(trips.map((t) => t.destination)).size,
            icon: Globe,
          ...
          <div
            key={i}
            className="p-8 bg-slate-50/50 dark:bg-slate-900/50 rounded-[2rem] border border-slate-100 dark:border-slate-800 space-y-4"
          >
            <div
              className={`p-3 w-fit rounded-xl bg-white dark:bg-slate-800 shadow-sm ${item.color}`}
            >
              <item.icon size={20} />
            </div>
            <div>
              ...
              <h3 className="text-3xl font-bold tracking-tighter mt-1">
                {item.val}
              </h3>
            </div>
          </div>
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
              {trips.length > 0 ? (
                ...
                <tr>
                  <td
                    colSpan={4}
                    className="px-10 py-20 text-center text-slate-300 font-bold uppercase tracking-widest text-xs"
                  >

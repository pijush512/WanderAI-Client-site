...
export default function MyReviewsPage() {
  ...
  const handleDeleteReview = async (id: string) => {
    ...
    try {
      ...
      await axios.delete(
        `https://wander-ai-server-site.vercel.app/api/v1/ai/my-reviews/${id}`,
        {
          headers: { Authorization: `Bearer ${token}` },
        },
      );
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 text-sm font-medium tracking-tight">
            Manage and track your feedback history.
          </p>
        </div>
                  ...
                  >
                    <td className="px-8 py-6">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="font-black text-slate-900 dark:text-white uppercase tracking-tighter leading-tight">
                            {review.tripId?.destination || "Unknown"}
                          </p>
                    ...
                    <td className="px-8 py-6 max-w-xs italic text-slate-500 dark:text-slate-400 text-sm truncate font-medium">
                      "{review.comment}"
                    </td>
                    <td className="px-8 py-6">

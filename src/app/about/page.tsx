    ...
    const fetchStats = async () => {
      try {
        const apiUrl =
          ...
          "https://wander-ai-server-site.vercel.app/api/v1";
    ...
    <section className="min-h-screen bg-white dark:bg-[#020617] transition-all duration-500 overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-6xl md:text-8xl font-black text-slate-900 dark:text-white tracking-tighter uppercase leading-[0.9] mb-10">
                Beyond <span className="text-blue-600 italic">Ordinary</span>{" "}
                <br /> Journeys.
              </h1>
              <p className="text-lg text-slate-500 dark:text-slate-400 max-w-lg font-medium leading-relaxed">
                WanderAI isn&apos;t just a travel planner. We are a team of
                explorers and engineers redefining how humans discover the world
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="p-8 bg-slate-50/50 dark:bg-slate-900/40 border border-slate-100 dark:border-slate-800 rounded-[2.5rem] transform hover:-translate-y-2 transition-transform duration-500">
                ...
                <p className="text-slate-500 dark:text-slate-400 font-bold text-[9px] uppercase tracking-widest mt-1">
                  Explorers
                </p>
              </div>
              <div className="p-8 bg-blue-600 rounded-[2.5rem] transform translate-y-8 hover:-translate-y-2 transition-transform duration-500 shadow-xl shadow-blue-500/20">
                ...
                <p className="text-blue-100 font-bold text-[9px] uppercase tracking-widest mt-1">
                  AI Plans
                </p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="max-w-4xl">
            <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter leading-none mb-12">
              ...
              <span className="text-blue-500">World-Class</span> Travel
              accessible to everyone, everywhere.
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 text-slate-400 font-medium">
              <p>
                We started with a simple question: Why is travel planning so
                stressful? In a world of infinite choices, WanderAI filters the
                noise to bring you experiences that truly matter.
              </p>
              <p>
                By blending real-time data with personalized AI, we ensure every
                trip you take is optimized for joy, safety, and discovery.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="py-32 max-w-7xl mx-auto px-6">
        <div className="text-center mb-20">
          ...
          <p className="text-3xl md:text-5xl font-black text-slate-900 dark:text-white uppercase tracking-tighter">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="group">
            ...
            <h4 className="text-xl font-black text-slate-900 dark:text-white uppercase mb-4 tracking-tight">
              Hyper-Personalization
            </h4>
            <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed">
              No two travelers are alike. Our AI learns your preferences to
              curate trips that reflect your unique personality.
            </p>
          </div>
          ...
          <div className="group">
            ...
            <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed">
              From the hidden streets of Tangail to the skyscrapers of Tokyo, we
              bring the world&apos;s best destinations to your fingertips.
            </p>
          </div>
          ...
          <div className="group">
            ...
            <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed">
              Technology is our tool, but humans are our focus. We prioritize
              safety, ethics, and sustainability in every plan.
            </p>
          </div>
        </div>
      </div>
